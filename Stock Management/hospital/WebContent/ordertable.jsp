...
String q="SELECT COUNT(*) as count FROM products WHERE stock<=re_order_point";
PreparedStatement pst=con.prepareStatement(q);
ResultSet rs=pst.executeQuery();
if(rs.next()){
%> 
    <label>Total No of Stock Orders</label>
    <input type="text" name="total" value="<%=rs.getString("count") %>" placeholder="" style="font-weight: bold; text-align: center;font-size: large; color: red;" >
...
Connection con=dbconnect.connect();
String q="SELECT * FROM products WHERE stock<=re_order_point";
PreparedStatement pst=con.prepareStatement(q);
ResultSet rs=pst.executeQuery();
while(rs.next()){
%> 
    <tr>
      ...
      <td><a href="./updateOrder.jsp?&itemID=<%=rs.getString("ID")%>"><button id="Ebtn"><i class="fa fa-home"></i>Ordered</button></a></td>
    </tr>
<% 
}
