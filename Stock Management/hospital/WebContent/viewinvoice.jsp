...
<body>
 ...
 <form method="POST" action="addbill">
  ...
  <div>
    ...
    <input type="text" name="invno" placeholder="" value="<%=request.getParameter("invno") %>" style="color: red; font-weight: bold; font-size: large; text-align: center;" readonly="readonly" >
  </div>
