...
<body>
 ...
 <form method="POST" action="newaddbill">
   <div>
    <label>Date</label>
...
String q="select * from invoice order by ID desc";
PreparedStatement pst=con.prepareStatement(q);
ResultSet rs=pst.executeQuery();
if(rs.next()){
	String itemcode=rs.getString("inv_no").trim();
...
%>    
    ...
    <input type="text" value=<%=procode%> name="invno" style="color: red; font-weight: bold;" readonly="readonly" placeholder=""  >
...
%>
    <label>Invoice No</label>
    <input type="text" value="INV1001" name="invno" style="color: red; font-weight: bold;" readonly="readonly" placeholder=""  >
<%	
}
...
%>  
  ...
  <div>
    <label>Qty</label>
    <input type="text" name="qty" placeholder="Amount"  >
  </div>
  

  
  <div method="POST" action="newaddbill">
