	...
	<div class="container">
		...
		<div class="sidebar">
			<nav>
				...
				<ul>
                                    <li class="active"><a href="ordertable.jsp">Orders</a></li>   
		...
		<div class="main-content">
			<h1>Register user</h1>			
       <form id="form1" method="get" action="orderupdate" enctype="multipart/form-data"> 
       	    	<%
					try {
       ...
       <input name="itemid" value="<%=rs.getString("ID") %>" type="hidden" placeholder="Customer Name"  id="name" readonly="readonly">
            ...
            <div class="">
                ...
                <div class="form-group">
                    <input name="proname" value="<%=rs.getString("pro_name") %>" type="text" placeholder="Customer Name" class="form-control" id="name" readonly="readonly">
                </div>
<!----------->
                 <div class="row">
                    ...
                    <div class="form-group col-sm-6 col-xs-6">
                    	 <input name="price" value="<%=rs.getString("price") %>" type="text" placeholder="Work Place" class="form-control" id="name" readonly="readonly">
                    </div>
                </div>
              <!----------------->  
                <!-- number of documents -->
                <div class="row">
                    <div class="form-group col-sm-6 col-xs-6">
                        <input name="stock" value="<%=rs.getString("stock") %>" type="text" placeholder="Email" class="form-control" id="name" readonly="readonly">
                    </div>
                    <div class="form-group col-sm-6 col-xs-6">
                        <input name="repoint" value="<%=rs.getString("re_order_point") %>" type="text" placeholder="Phone no" class="form-control" id="description" readonly="readonly">
                    </div>
                </div>
              ...
              <!-- -->
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6 col-xs-6">
                        <textarea name="description" placeholder="Comments" value="<%=rs.getString("description") %>" class="form-control" readonly="readonly"><%=rs.getString("description") %></textarea>
                    </div>
                    
                                    <div class="row">
                    
                    <div class="form-group col-sm-6 col-xs-6">
                        <textarea name="newstk" placeholder="Ordered Qty" class="form-control" style="resize: none; width: 250px; height: 35px" ></textarea>
                    </div>
