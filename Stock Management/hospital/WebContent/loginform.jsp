...
<body>
<form method="post" action="loginsign">
	...
	<div class="login-html">
		...
		<div class="login-form">
			...
			<div class="sign-up-htm">
				...
				<div class="group">
					<label for="mail" class="label">Phone</label>
				...
				<div class="group">
					...
					<input name="confirmpass" type="password" class="input" data-type="password">
				</div>
				<div class="group" method="post" action="loginreg">
