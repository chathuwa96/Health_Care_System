		...
		<div class="sidebar">
			<nav>
				...
				<ul>
                                    ...
                                    <li class="active"><a href="invoicestable.jsp">View Invoices</a></li>
...
<form action="invoicesch.jsp" method="POST">
  <div>
...
<%
try{
String invno=request.getParameter("keyword");	
Connection con=dbconnect.connect();
String q="select inv_no,SUM(subtot) as tot from invoice where inv_no like '"+"%"+invno+"%" +"'  group by inv_no";
...
%>
    ...
    <tr>
      ...
      <td><a href="./viewinvoice.jsp?&invno=<%=rs.getString("inv_no")%>"><button id="Ebtn"><i class="fa fa-home"></i> View</button></a></td>
    </tr>
