...
// View patient by appointmentID

		@GET
		@Path("/{appointmentID}")
		// @Consumes(MediaType.APPLICATION_JSON)
		@Produces(MediaType.APPLICATION_JSON)
		public List<AppointmentBean> readDoctorByDept(@PathParam("appointmentID") String appointmentID) {
			List<AppointmentBean> list;
			list = appObj.viewPatientByID(appointmentID);
			return list;
